...
- `.forEach` returns nothing has to go through the whole array without stopping, `.map` returns a new array.
2. What is the difference between a function and a method?
- A method is a built in function for javaScript and a function is a piece of reusable code made by the user.
3. What is closure?
- A function with a function as an argument.
...
- `super()` extends the data and information from the parent class.
